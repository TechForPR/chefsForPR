...
var createDeliveriesTable = function (docs) {
    ...
    var result = '<table class="table table-striped">';
    result += '<tbody>';
    result += '<thead><tr><th>Municipality Name</th><th>Agency</th><th>Created On</th><th># of Meals Delivered</th><th>Details</th></tr></thead>'
    for (var i = 0; i < docs.length; i++) {
        result += '<tr>';
        result += '  <td>' + (docs[i].municipalityName || '') + '</td>';
